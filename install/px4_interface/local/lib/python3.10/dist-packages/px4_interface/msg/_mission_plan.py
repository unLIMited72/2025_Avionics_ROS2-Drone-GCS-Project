...
class Metaclass_MissionPlan(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'SPACING_TIME': cls.__constants['SPACING_TIME'],
        }

    @property
    def LANDING_HOME(self):
        """Message constant 'LANDING_HOME'."""
        return Metaclass_MissionPlan.__constants['LANDING_HOME']

    @property
    def LANDING_LAST_WAYPOINT(self):
        """Message constant 'LANDING_LAST_WAYPOINT'."""
        return Metaclass_MissionPlan.__constants['LANDING_LAST_WAYPOINT']

    @property
    def SPACING_DISTANCE(self):
        """Message constant 'SPACING_DISTANCE'."""
        return Metaclass_MissionPlan.__constants['SPACING_DISTANCE']

    @property
    def SPACING_TIME(self):
        """Message constant 'SPACING_TIME'."""
        return Metaclass_MissionPlan.__constants['SPACING_TIME']
