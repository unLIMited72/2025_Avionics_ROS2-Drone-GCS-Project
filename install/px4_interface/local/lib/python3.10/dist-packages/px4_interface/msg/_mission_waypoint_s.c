...
bool px4_interface__msg__mission_waypoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_interface.msg._mission_waypoint.MissionWaypoint", full_classname_dest, 51) == 0);
  }
  px4_interface__msg__MissionWaypoint * ros_message = _ros_message;
  {  // seq
  ...
  {  // hold_time
    ...
    assert(PyFloat_Check(field));
    ros_message->hold_time = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of MissionWaypoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_interface.msg._mission_waypoint");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MissionWaypoint");
