...
{
  new (message_memory) px4_interface::msg::MissionCommand(_init);
}

void MissionCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4_interface::msg::MissionCommand *>(message_memory);
  typed_message->~MissionCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MissionCommand_message_member_array[2] = {
  {
    "mission_id",  // name
    ...
    offsetof(px4_interface::msg::MissionCommand, mission_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_interface::msg::MissionCommand, command),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MissionCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(px4_interface::msg::MissionCommand),
...
get_message_type_support_handle<px4_interface::msg::MissionCommand>()
{
  return &::px4_interface::msg::rosidl_typesupport_introspection_cpp::MissionCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_interface, msg, MissionCommand)() {
  return &::px4_interface::msg::rosidl_typesupport_introspection_cpp::MissionCommand_message_type_support_handle;
}
