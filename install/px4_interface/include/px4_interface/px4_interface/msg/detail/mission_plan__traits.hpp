...
#ifndef PX4_INTERFACE__MSG__DETAIL__MISSION_PLAN__TRAITS_HPP_
#define PX4_INTERFACE__MSG__DETAIL__MISSION_PLAN__TRAITS_HPP_
...
inline void to_yaml(
  const px4_interface::msg::MissionPlan & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4_interface::msg::MissionPlan & msg)
{
  return px4_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4_interface::msg::MissionPlan>()
{
  return "px4_interface::msg::MissionPlan";
}

template<>
inline const char * name<px4_interface::msg::MissionPlan>()
{
  return "px4_interface/msg/MissionPlan";
}

template<>
struct has_fixed_size<px4_interface::msg::MissionPlan>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<px4_interface::msg::MissionPlan>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<px4_interface::msg::MissionPlan>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_INTERFACE__MSG__DETAIL__MISSION_PLAN__TRAITS_HPP_
