...
#ifndef PX4_INTERFACE__MSG__DETAIL__MISSION_PLAN__STRUCT_HPP_
#define PX4_INTERFACE__MSG__DETAIL__MISSION_PLAN__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__px4_interface__msg__MissionPlan __attribute__((deprecated))
#else
# define DEPRECATED__px4_interface__msg__MissionPlan __declspec(deprecated)
#endif
...
struct MissionPlan_
{
  ...
  static constexpr uint8_t SPACING_DISTANCE =
    0u;
  static constexpr uint8_t SPACING_TIME =
    1u;

  // pointer types
  using RawPtr =
    px4_interface::msg::MissionPlan_<ContainerAllocator> *;
  using ConstRawPtr =
    const px4_interface::msg::MissionPlan_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      px4_interface::msg::MissionPlan_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__px4_interface__msg__MissionPlan
    std::shared_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__px4_interface__msg__MissionPlan
    std::shared_ptr<px4_interface::msg::MissionPlan_<ContainerAllocator> const>
...
using MissionPlan =
  px4_interface::msg::MissionPlan_<std::allocator<void>>;

// constant definitions
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t MissionPlan_<ContainerAllocator>::LANDING_HOME;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t MissionPlan_<ContainerAllocator>::LANDING_LAST_WAYPOINT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t MissionPlan_<ContainerAllocator>::SPACING_DISTANCE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t MissionPlan_<ContainerAllocator>::SPACING_TIME;
#endif  // __cplusplus < 201703L
...
#endif  // PX4_INTERFACE__MSG__DETAIL__MISSION_PLAN__STRUCT_HPP_
