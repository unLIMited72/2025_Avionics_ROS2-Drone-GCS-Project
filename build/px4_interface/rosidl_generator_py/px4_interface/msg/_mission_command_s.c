...
bool px4_interface__msg__mission_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_interface.msg._mission_command.MissionCommand", full_classname_dest, 49) == 0);
  }
  px4_interface__msg__MissionCommand * ros_message = _ros_message;
  {  // mission_id
...
PyObject * px4_interface__msg__mission_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_interface.msg._mission_command");
