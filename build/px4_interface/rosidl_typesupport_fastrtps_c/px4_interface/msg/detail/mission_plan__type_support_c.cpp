...
#include "px4_interface/msg/detail/mission_plan__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // drone_ids, mission_id
#include "rosidl_runtime_c/string_functions.h"  // drone_ids, mission_id
...
using _MissionPlan__ros_msg_type = px4_interface__msg__MissionPlan;
...
size_t get_serialized_size_px4_interface__msg__MissionPlan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MissionPlan__ros_msg_type * ros_message = static_cast<const _MissionPlan__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MissionPlan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_interface__msg__MissionPlan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_interface
size_t max_serialized_size_px4_interface__msg__MissionPlan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_interface__msg__MissionPlan;
    is_plain =
      (
...
static size_t _MissionPlan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_interface__msg__MissionPlan(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_interface, msg, MissionPlan)() {
