...
#include "px4_interface/msg/detail/mission_status__rosidl_typesupport_fastrtps_c.h"
...
using _MissionStatus__ros_msg_type = px4_interface__msg__MissionStatus;
...
static uint32_t _MissionStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_interface__msg__MissionStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_interface__msg__MissionStatus;
    is_plain =
      (
...
static size_t _MissionStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4_interface__msg__MissionStatus(
