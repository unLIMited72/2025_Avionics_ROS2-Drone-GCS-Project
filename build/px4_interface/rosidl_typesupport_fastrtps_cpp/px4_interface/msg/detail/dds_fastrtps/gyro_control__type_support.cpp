...
#include "px4_interface/msg/detail/gyro_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_interface::msg::GyroControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_interface::msg::GyroControl & ros_message)
{
  // Member: drone_id
  cdr >> ros_message.drone_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4_interface
max_serialized_size_GyroControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_interface::msg::GyroControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_interface::msg::GyroControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_interface::msg::GyroControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GyroControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_interface::msg::GyroControl *>(
...
static size_t _GyroControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GyroControl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GyroControl__callbacks = {
  "px4_interface::msg",
  "GyroControl",
...
static rosidl_message_type_support_t _GyroControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GyroControl__callbacks,
...
{
  return &px4_interface::msg::typesupport_fastrtps_cpp::_GyroControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_interface, msg, GyroControl)() {
  return &px4_interface::msg::typesupport_fastrtps_cpp::_GyroControl__handle;
}
