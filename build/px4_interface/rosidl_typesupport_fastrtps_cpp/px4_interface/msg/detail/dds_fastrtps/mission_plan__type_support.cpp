...
#include "px4_interface/msg/detail/mission_plan__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4_interface::msg::MissionPlan & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4_interface::msg::MissionPlan & ros_message)
{
  // Member: mission_id
  cdr >> ros_message.mission_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_interface::msg::MissionPlan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_interface::msg::MissionPlan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_interface::msg::MissionPlan *>(
    untyped_ros_message);
...
{
  return &px4_interface::msg::typesupport_fastrtps_cpp::_MissionPlan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_interface, msg, MissionPlan)() {
  return &px4_interface::msg::typesupport_fastrtps_cpp::_MissionPlan__handle;
}
