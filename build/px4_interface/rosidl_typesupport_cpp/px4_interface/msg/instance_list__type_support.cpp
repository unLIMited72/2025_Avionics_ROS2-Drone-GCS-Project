...
static const _InstanceList_type_support_symbol_names_t _InstanceList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4_interface, msg, InstanceList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4_interface, msg, InstanceList)),
  }
};
...
{
  return &::px4_interface::msg::rosidl_typesupport_cpp::InstanceList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4_interface, msg, InstanceList)() {
  return get_message_type_support_handle<px4_interface::msg::InstanceList>();
}
